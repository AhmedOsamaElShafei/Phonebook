...
{
    FILE*f1;
    f1= fopen("G:\\Term 3\\Programming\\Phone Notebook\\phonebook.txt","r");
    char c;
...
void Add(notebook c1[])
{
    ...
    c1[students-1].address[strlen(c1[students-1].address)-1] = 0;
    //fflush(stdin);
    //scanf("%s",c1[students-1].address);
...
{
    FILE*f1=fopen("G:\\Term 3\\Programming\\Phone Notebook\\phonebook.txt","w");
    int i,j;
    for(i=0; i<students; i++)
    {
